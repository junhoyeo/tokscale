...
| <img width="48px" src="https://github.com/XiaomiMiMo.png" alt="Xiaomi MiMo AI" /> | Xiaomi MiMo AI (desktop) | MiMo Code와 동일한 `~/.local/share/mimocode/mimocode.db` 저장소; `session.version`이 `desktop-`로 시작하면 `micode-desktop`으로 분류 |
