...
| <img width="48px" src=".github/assets/client-meept.png" alt="Meept" /> | [Meept](https://github.com/bhodgens/meept) | `~/.meept/metrics.db` (호출별 `llm_calls` 행; 세션 ID 및 reasoning/캐시-생성 토큰은 스키마 v2부터; 오류 행 제외) |
