...
export declare function finalizeAgentReport(options: FinalizeAgentOptions): AgentReport
...
export declare function getAgentReport(options: ReportOptions): AgentReport
