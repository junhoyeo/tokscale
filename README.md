...
| <img width="48px" src="https://aitop100app-1251510006.cos.ap-shanghai.myqcloud.com/article/undefined/e2be6f30-0b19-4d14-8a7a-7767a5e8bad1.png" alt="CodeBuddy" /> | [CodeBuddy](https://www.codebuddy.cn/docs/cli/overview) (CLI, IDE, VS Code plugin) | `~/.codebuddy/projects/**/*.jsonl` + extension logs | ✅ Yes |
| <img width="48px" src="https://codebuddy-1328495429.cos.accelerate.myqcloud.com/web/workbuddy/d1d0b9329b771f020a1025d11661a33296390d7c/assets/workbuddy-icon-BujKiC6G.svg" alt="WorkBuddy" /> | WorkBuddy | `~/.workbuddy/projects/**/*.jsonl` + SQLite fallback | ✅ Yes |
