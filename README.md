...
| <img width="48px" src="https://github.com/XiaomiMiMo.png" alt="Xiaomi MiMo AI" /> | Xiaomi MiMo AI (desktop) | Same `~/.local/share/mimocode/mimocode.db` store as MiMo Code; sessions are split by `session.version` (`desktop-` prefix → `micode-desktop`) |
