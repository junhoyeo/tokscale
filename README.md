...
| <img width="48px" src=".github/assets/client-fx.png" alt="fx" /> | [fx](https://fx.sh/) | `~/.fx/sessions/*/usage-v2.json` (cumulative usage snapshot per session; sibling `session.json` supplies session ID, workspace root, and timestamp) |
