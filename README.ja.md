...
| <img width="48px" src="https://github.com/XiaomiMiMo.png" alt="Xiaomi MiMo AI" /> | Xiaomi MiMo AI（デスクトップ） | MiMo Code と同じ `~/.local/share/mimocode/mimocode.db`；`session.version` が `desktop-` で始まるセッションは `micode-desktop` として区別 |
