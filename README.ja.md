...
| <img width="48px" src=".github/assets/client-meept.png" alt="Meept" /> | [Meept](https://github.com/bhodgens/meept) | `~/.meept/metrics.db`（呼び出しごとの `llm_calls` 行。セッションIDと reasoning/キャッシュ作成トークンはスキーマ v2 以降。エラー行は除外） |
