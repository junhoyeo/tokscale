...
const fn tr_ja(key: MessageKey) -> Option<&'static str> {
    Some(match key {
        ...
        MessageKey::ColMessages => "メッセージ",
        MessageKey::ColInput => "入力",
        MessageKey::ColOutput => "出力",
        MessageKey::ColCacheRead => "キャッシュ読込",
        MessageKey::ColCacheWrite => "キャッシュ書込",
...
const fn tr_fr(key: MessageKey) -> Option<&'static str> {
    Some(match key {
        ...
        MessageKey::ColCacheRead => "Lecture cache",
        MessageKey::ColCacheWrite => "Écriture cache",
        MessageKey::ColSession => "Session",
        ...
        MessageKey::ColLastActive => "Dernière activité",
        ...
        MessageKey::EmptyNoMinutelyData => "Aucune donnée d'utilisation par minute trouvée. Appuyez sur 'r' pour actualiser.",
