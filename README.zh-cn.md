...
| <img width="48px" src=".github/assets/client-meept.png" alt="Meept" /> | [Meept](https://github.com/bhodgens/meept) | `~/.meept/metrics.db`（逐调用 `llm_calls` 行；会话 ID 与 reasoning/缓存写入 token 自 schema v2 起提供；错误行已排除） |
